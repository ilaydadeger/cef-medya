  ...
  return (
    <header
      className={cn(
        ...
        isScrolled ? "bg-[#0A0A0A]/90 backdrop-blur-xl py-2" : "bg-[#0A0A0A]/50 backdrop-blur-md py-3"
      )}
    >
      <div className="container mx-auto px-6 md:px-12 flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center gap-2">
          {data.general.faviconUrl ? (
            <img src={data.general.faviconUrl} alt="Cef Medya Logo" className="h-16 md:h-20 object-contain" />
          ) : (
        ...
        <nav className="hidden md:flex items-center gap-10">
          <Link to="/" className="relative group text-[#f4f2ee] font-medium text-sm tracking-wide transition-colors hover:text-[#e94e1b]">
            Ana Sayfa
          ...
          >
            <a href="#" className="flex items-center gap-1 text-[#f4f2ee] font-medium text-sm tracking-wide transition-colors group-hover:text-[#01aca2]">
              Kurumsal <ChevronDown className="w-4 h-4 transition-transform group-hover:rotate-180" />
            ...
            <AnimatePresence>
              {isKurumsalOpen && (
                ...
                >
                  <div className="py-2">
                    {['Hakkımızda', 'Hizmetlerimiz', 'Ekibimiz', 'Sıkça Sorulan Sorular'].map((item, idx) => (
                      <Link
                        key={idx}
                        to={item === 'Hakkımızda' ? '/hakkimizda' : item === 'Hizmetlerimiz' ? '/hizmetler' : item === 'Ekibimiz' ? '/takimimiz' : item === 'Sıkça Sorulan Sorular' ? '/sss' : '/'}
          ...
          <Link to="/portfolyo" className="relative group text-[#f4f2ee] font-medium text-sm tracking-wide transition-colors hover:text-[#e94e1b]">
            Portfolyo
            <span className="absolute -bottom-2 left-0 w-0 h-[2px] bg-[#e94e1b] transition-all duration-300 group-hover:w-full"></span>
          </Link>

          <Link to="/iletisim" className="relative group text-[#f4f2ee] font-medium text-sm tracking-wide transition-colors hover:text-[#01aca2]">
            İletişim
            <span className="absolute -bottom-2 left-0 w-0 h-[2px] bg-[#01aca2] transition-all duration-300 group-hover:w-full"></span>
          </Link>
