        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 pb-16">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-[#f4f2ee]/50 max-w-sm mb-8 leading-relaxed font-light">
              Hikayenizi en güçlü görsellerle anlatmak için buradayız.
              Prodüksiyondan dijitale tam hizmet yaratıcı ajans.
            </p>
              ...
              {socialLinks.map((item, i) => {
                ...
                return (
                  <a
                    ...
                    className="w-10 h-10 rounded-sm bg-transparent border border-white/10 flex items-center justify-center text-[#f4f2ee] hover:border-[#f4f2ee] hover:text-cef-orange transition-all duration-300"
                  >
          ...
          <div>
            <h4 className="text-[#f4f2ee] font-medium mb-6 font-montserrat tracking-widest uppercase text-sm">
              Bağlantılar
            </h4>
            <ul className="space-y-3">
              <li>
                <Link
                  to="/hakkimizda"
                  className="text-[#f4f2ee]/50 font-light hover:text-[#f4f2ee] transition-colors text-sm"
                >
                  Hakkımızda
                </Link>
              </li>
              ...
              <li className="mt-4 pt-4 border-t border-white/5 leading-relaxed">
                {data.general.contact.address.split(",").map((line, index) => (
                  <React.Fragment key={index}>
                    {line}
                    {index !==
                      data.general.contact.address.split(",").length - 1 && (
                      <br />
                    )}
                  </React.Fragment>
                ))}
