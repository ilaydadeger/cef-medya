...
export const defaultCmsData: CmsData = {
  general: {
    ...
    faviconUrl: '',
    contact: {
      address: 'Müslhittin, Cemal Karamuğla Sk. No:50, 48000 Muğla Merkez/Muğla',
  ...
  faqPage: {
    heroBg: "https://images.unsplash.com/photo-1557804506-669a67965ba0?q=80&w=2074&auto=format&fit=crop"
  },
  home: {
    heroTitle: 'Markanızı Geleceğe Taşıyın.',
    heroSubtitle: 'Cef Medya ile dijital dünyada izinizi bırakın. Strateji, tasarım ve teknolojiyi birleştirerek markanızı büyütüyoruz.',
    heroItems: [
      { title: "Grafik Tasarım", bgImg: "https://images.unsplash.com/photo-1626785774573-4b799315345d?q=80&w=2071&auto=format&fit=crop", accent: "turquoise" },
      { title: "Video Prodüksiyon", bgImg: "https://images.unsplash.com/photo-1590102604515-bb821db265e3?q=80&w=2070&auto=format&fit=crop", accent: "orange" },
      { title: "Profesyonel Çekim", bgImg: "https://images.unsplash.com/photo-1516035069371-29a1b244cc32?q=80&w=2064&auto=format&fit=crop", accent: "orange" },
      { title: "Sosyal Medya", bgImg: "https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?q=80&w=1974&auto=format&fit=crop", accent: "turquoise" }
    ],
    nelerYapiyoruz: {
      ...
      desc1: "Her proje benzersiz bir vizyonla doğar. Stüdyomuz, sıradanı aşan prodüksiyon kalitesiyle markaların özünü yakalar ve onları görsel bir şölene dönüştürür.",
      desc2: "Tasarım disiplinimiz sakin, ölçülü ve her zaman detaylarda gizli mükemmelliği arar. Yapaylıktan uzak, gerçek hikayeler üretiyoruz.",
      img1: "https://images.unsplash.com/photo-1536440136628-849c177e76a1?q=80&w=1925&auto=format&fit=crop",
      img2: "https://images.unsplash.com/photo-1598899134739-24c46f58b8c0?q=80&w=2056&auto=format&fit=crop"
    },
    videoSteps: [
      {
        step: '1. ADIM',
        ...
        items: ['Hedef kitle analizi', 'Hikaye kurgusu', 'Görsel referansların belirlenmesi']
      },
      {
        step: '2. ADIM',
        title: 'Çekim & Prodüksiyon',
        desc: 'Fikirler gerçeğe dönüşüyor.',
        items: ['Profesyonel ekipmanlarla çekim', 'Mekan ve ışık yönetimi', 'Yüksek kaliteli ham kayıt']
      },
      {
        step: '3. ADIM',
        title: 'Kurgu & Post-Prod.',
        desc: 'Görseller işlenip ritim buluyor.',
        items: ['Renk düzenlemesi (Color Grading)', 'Ses miksajı ve efektler', 'Dinamik geçişler ve montaj']
      },
      {
        step: '4. ADIM',
        title: 'Yayın & Dağıtım',
        desc: 'Eseriniz dünyayla buluşuyor.',
        items: ['Platformlara özel formatlama', 'SEO uyumlu başlık ve metinler', 'Performans takibi ve analiz']
      }
    ],
    founder: {
      quote: "Animasyon, grafik ve dijital prodüksiyon alanında ustalığın gururudur.",
      backgroundTextEn: "ANIMATION, GRAPHICS AND DIGITAL PRODUCTION, CRAFTED WITH BRILLIANCE, LOVE, AND CARE.",
      name: "Cemal DÜLGER",
      role: "Kurucu"
    },
    stats: {
  ...
  about: {
    mission: 'Markaların dijital dünyadaki varlıklarını güçlendirmek için yenilikçi, estetik ve işlevsel çözümler sunmak.',
    vision: 'Sektördeki en iyi görsel iletişim ajansı olmak, yaratıcılığı teknolojiyle birleştirerek sınırları zorlamak.',
    values: [
      { title: 'Strateji', desc: 'Markanızın hedeflerine ulaşması için veriye dayalı, yaratıcı rotalar çiziyoruz.' },
      { title: 'Tasarım', desc: 'Estetik ve fonksiyonu birleştirerek dijital dünyada iz bırakan arayüzler kurguluyoruz.' },
      { title: 'Prodüksiyon', desc: 'Sinematik kalite standartlarında yüksek etkileşimli görsel hikayeler üretiyoruz.' }
    ]
  },
  aboutPage: {
    heroBg: "https://images.unsplash.com/photo-1576280314550-773c50583407?auto=format&fit=crop&q=80&w=1920",
    modernDesign: {
      subtitle: "MODERN TASARIM",
      title: "Dijital geleceği \n sizin için tasarlıyor \n ve yaratıyoruz.",
      image: "https://images.unsplash.com/photo-1699621106755-4fe40ce95d64?auto=format&fit=crop&q=80&w=1080"
    },
    videoUrl: "",
    brands: [
      { image: "https://upload.wikimedia.org/wikipedia/commons/4/44/BMW.svg", name: "gotha" },
      { image: "https://upload.wikimedia.org/wikipedia/commons/4/44/BMW.svg", name: "logo2" },
      { image: "https://upload.wikimedia.org/wikipedia/commons/4/44/BMW.svg", name: "MAG NET" },
      { image: "https://upload.wikimedia.org/wikipedia/commons/4/44/BMW.svg", name: "magnus" },
      { image: "https://upload.wikimedia.org/wikipedia/commons/4/44/BMW.svg", name: "moon" },
      { image: "https://upload.wikimedia.org/wikipedia/commons/4/44/BMW.svg", name: "Opilgo" }
    ],
    creativeApproach: {
  ...
  servicesPage: {
    heroBg: "https://images.unsplash.com/photo-1611784728558-6c7d9b409cdf?auto=format&fit=crop&q=80&w=1920",
    intro: {
    ...
    surprise: {
      ...
      videoPlaceholder: "https://images.unsplash.com/photo-1535016120720-40c746a46dc6?q=80&w=2070&auto=format&fit=crop"
    },
    strengths: {
      title: "Güçlü Yönlerimiz",
      items: [
        { title: "Animation", image: "https://images.unsplash.com/photo-1550745165-9bc0b252726f?q=80&w=2070&auto=format&fit=crop" },
        { title: "Commercial", image: "https://images.unsplash.com/photo-1601506521937-0121a7fc2a6b?q=80&w=2070&auto=format&fit=crop" },
        { title: "Music Videos", image: "https://images.unsplash.com/photo-1598387181032-a310322db565?q=80&w=2070&auto=format&fit=crop" },
        { title: "Movies", image: "https://images.unsplash.com/photo-1485846234645-a62644f84728?q=80&w=2070&auto=format&fit=crop" }
      ]
    }
  },
  services: [
    ...
    },
    {
      ...
      detail: {
        ...
        intro: 'Bir web sitesi, markanızın 7/24 açık olan vitrinidir. CEF Medya olarak tasarladığımız her site; hız, estetik ve kullanıcı deneyimini bir arada sunacak şekilde kurgulanır. Mobil öncelikli yaklaşımımız ve SEO uyumlu altyapımızla dijital varlığınızı rakiplerinizin önüne taşıyoruz.',
        sections: [
          {
    ...
    },
    {
      ...
      detail: {
        tagline: 'Her kare bir his, her sahne bir hikaye — sinematik prodüksiyon.',
        intro: 'CEF Medya prodüksiyon ekibi; kurumsal tanıtım filmlerinden ürün reklamlarına, etkinlik çekimlerinden sosyal medya içeriklerine kadar geniş bir yelpazede hizmet verir. Profesyonel kamera sistemleri, drone ve jib ekipmanlarımızla sahnelerinizi sinematik bir kaliteye taşıyoruz.',
        sections: [
          {
    ...
    },
    {
      ...
      detail: {
        tagline: 'Strateji, içerik ve topluluk — markanızın dijital sesi bizde güvende.',
        intro: 'Sosyal medya artık sadece paylaşım yapmak değil; marka inşa etmek, topluluk oluşturmak ve satışa dönüştürmektir. CEF Medya olarak Instagram, TikTok, LinkedIn ve YouTube gibi platformlarda markanızın sesini tutarlı ve etkili biçimde yönetiyoruz.',
        sections: [
          {
  ...
  faq: [
    {
      label: 'Süreç',
      items: [
        { q: 'Bir projeyi teslim almak ne kadar sürer?', a: 'Kapsama göre değişir: logo 5-10 gün, web sitesi 2-4 hafta arası sürebilir.' },
        { q: 'Kaç revizyon hakkım var?', a: 'Her paket en az 2 revizyon turu içerir.' }
      ]
    },
    {
      label: 'Fiyatlandırma',
      items: [
        { q: 'Fiyatlandırmanız nasıl belirleniyor?', a: 'Sabit bir liste yerine kapsam bazlı fiyatlandırma yapıyoruz.' }
      ]
    }
  ],
  portfolio: {
    heroBg: "",
    categories: ['Tümünü Gör', 'Prodüksiyon', 'Tasarım', 'Fotoğrafçılık', 'Sosyal Medya'],
    projects: [
      { id: '1', title: 'Urban Lifestyle', category: 'Fotoğrafçılık', image: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&q=80&w=800' },
      { id: '2', title: 'Noir Film', category: 'Prodüksiyon', image: 'https://images.unsplash.com/photo-1485846234645-a62644f84728?auto=format&fit=crop&q=80&w=800' },
      { id: '3', title: 'Tech Startup', category: 'Tasarım', image: 'https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&q=80&w=800' },
    ]
  }
};
...
export function CmsProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    const apiUrl = import.meta.env.VITE_API_BASE_URL || 'http://localhost:8000/api.php';
    fetch(`${apiUrl}?action=cms`)
      .then(res => res.json())
      .then(fetchedData => {
        if (fetchedData) {
          const merge = (target: any, source: any): any => {
            if (typeof target !== 'object' || target === null || Array.isArray(target)) return source !== undefined ? source : target;
            if (typeof source !== 'object' || source === null || Array.isArray(source)) return source !== undefined ? source : target;
  ...
  if (isLoading) {
    return <div className="min-h-screen bg-cef-black flex items-center justify-center text-cef-cream">Yükleniyor...</div>;
  }
