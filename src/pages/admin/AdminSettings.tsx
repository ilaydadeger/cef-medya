      ...
      <div className="p-8 md:p-12 max-w-4xl">
        <div className="mb-12">
          ...
          <p className="text-white/40 font-light">
            Web sitenizin genel görünümünü ve iletişim bilgilerini buradan
            yönetebilirsiniz.
          </p>
        </div>
              ...
              <div className="md:col-span-1">
                ...
                <div className="flex gap-4 items-center">
                  {formData.general.faviconUrl && (
                    <MediaRenderer
                      src={formData.general.faviconUrl}
                      alt="Favicon"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  value={formData.general.contact.phone}
                  onChange={handleChange}
              ...
              <div>
                ...
                <input
                  ...
                  value={formData.general.contact.email}
                  onChange={handleChange}
                  className="w-full bg-white/5 border border-white/10 rounded-lg py-3 px-4 text-sm outline-none focus:border-cef-orange transition-colors"
                />
              </div>
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  value={formData.general.contact.address}
                  onChange={handleChange}
                  className="w-full bg-white/5 border border-white/10 rounded-lg py-3 px-4 text-sm outline-none focus:border-cef-orange transition-colors"
                />
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  value={formData.general.socialLinks.linkedin}
                  onChange={handleChange}
                  className="w-full bg-white/5 border border-white/10 rounded-lg py-3 px-4 text-sm outline-none focus:border-white/50 transition-colors"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  value={formData.general.socialLinks.youtube}
                  onChange={handleChange}
                  className="w-full bg-white/5 border border-white/10 rounded-lg py-3 px-4 text-sm outline-none focus:border-white/50 transition-colors"
                />
              </div>
