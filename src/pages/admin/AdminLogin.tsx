        ...
        <div className="bg-white/[0.02] border border-white/5 backdrop-blur-2xl p-10 md:p-12 rounded-3xl shadow-[0_0_50px_rgba(0,0,0,0.5)]">
          <div className="text-center mb-10">
            <h1 className="text-3xl font-montserrat font-light tracking-tight mb-2">
              Sisteme <span className="text-cef-orange font-medium italic">Bağlan</span>
            </h1>
            <p className="text-cef-cream/50 text-sm tracking-widest uppercase">Yönetici Paneli</p>
          </div>
          ...
          <div className="mt-8 text-center">
             <button onClick={() => navigate('/')} className="text-xs text-white/30 hover:text-white/70 transition-colors tracking-widest uppercase">
               &larr; Siteye Dön
             </button>
          </div>
