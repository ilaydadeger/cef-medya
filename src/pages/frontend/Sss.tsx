          ...
          <div className="relative z-20 max-w-4xl">
            ...
            >
              ...
              <p className="text-[#888880] text-sm md:text-base max-w-sm leading-relaxed">
                Merak ettiklerinizin büyük çoğunluğunun yanıtı burada. Yanıt
                bulamazsanız doğrudan iletişime geçin.
              </p>
            </motion.div>
          </div>
        </section>
          ...
          >
            <div>
              ...
              >
                Doğrudan bize
                <br />
                <em style={{ fontStyle: "italic", color: "#e94e1b" }}>
                  yazın.
                </em>
              </h2>
            </div>
            <div>
              ...
              >
                Yanıt bulamadığınız sorularınız için 24 saat içinde dönüş
                garantisiyle ekibimize ulaşabilirsiniz.
              </p>
