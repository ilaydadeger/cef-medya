...
export default function HizmetDetay() {
  ...
  const service = data.services.find(
    (s) =>
      s.title.toLowerCase().replace(/\s+/g, "-") === decodedSlug ||
      s.title === decodedSlug,
  )
  ...
  if (!service) {
    return (
      <div className="bg-cef-black min-h-screen text-cef-cream flex flex-col items-center justify-center gap-6">
        ...
        <Link to="/hizmetler" className="text-cef-orange underline">
          Hizmetlere Dön
        </Link>
      </div>
    )
  ...
  return (
    <div
      className="bg-cef-black min-h-screen text-cef-cream"
    ...
    >
        ...
        <div className="relative z-20 max-w-4xl">
          ...
          >
            ...
            <div className="text-xs tracking-[0.3em] text-cef-cream/50 uppercase mb-6">
              ...
              <span className="mx-2">/</span>
              <span className="text-cef-orange font-medium uppercase">
                {service.title}
              </span>
            </div>
            ...
            <h1 className="text-5xl md:text-7xl font-light tracking-tighter mb-4 break-words">
              {service.title}
              <span className="text-cef-orange">.</span>
            </h1>
          </motion.div>
        </div>
      </section>
              ...
              >
                ...
                {section.img && (
                  ...
                  >
                    <MediaRenderer
                      ...
                      onMouseLeave={(e) => {
                        ;(e.currentTarget as HTMLImageElement).style.filter =
                          "grayscale(20%) contrast(1.1) brightness(0.8)"
                        ;(e.currentTarget as HTMLImageElement).style.transform =
                          "scale(1)"
                      }}
                    />
                ...
                <div
                  style={{
                    ...
                    border: section.img
                      ? "1px solid rgba(244, 242, 238, 0.06)"
                      : undefined,
                    boxShadow: section.img
      ...
      >
        ...
        <div style={{ maxWidth: "1000px", position: "relative", zIndex: 10 }}>
          ...
          >
            Vizyonunuzu <br />
            <span style={{ fontStyle: "italic", color: "#f4f2ee" }}>
          ...
          >
            ...
            <button
              ...
              onMouseEnter={(e) => {
                ...
                ;(e.currentTarget as HTMLElement).style.backgroundColor =
                  "rgba(244,242,238,0.05)"
              }}
              onMouseLeave={(e) => {
                ;(e.currentTarget as HTMLElement).style.borderColor =
                  "rgba(244,242,238,0.35)"
                ;(e.currentTarget as HTMLElement).style.backgroundColor =
                  "transparent"
              }}
            >
