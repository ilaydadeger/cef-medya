          ...
          {categories.map((cat, i) => (
            <button
              ...
              className={`text-sm tracking-widest uppercase transition-colors ${
                activeCategory === cat
                  ? "text-white border-b border-cef-orange pb-1"
              ...
              <React.Fragment key={chunkIdx}>
                ...
                {chunk[0] && (
                  <motion.div
                    ...
                    onClick={() =>
                      navigate(
                        `/portfolyo/${encodeURIComponent(chunk[0].title)}`,
                      )
                    }
                  ...
                  >
                    ...
                    <div className="absolute bottom-10 left-10 right-10 flex justify-between items-end">
                      <div>
                        <p className="text-cef-orange text-xs tracking-widest uppercase mb-2">
                          {chunk[0].category}
                        </p>
                ...
                {chunk[1] && (
                  <motion.div
                    ...
                    onClick={() =>
                      navigate(
                        `/portfolyo/${encodeURIComponent(chunk[1].title)}`,
                      )
                    }
                  ...
                  >
                    ...
                    <div className="absolute bottom-8 left-8 right-8 flex justify-between items-end">
                      <div>
                        <p className="text-cef-turquoise text-xs tracking-widest uppercase mb-2">
                          {chunk[1].category}
                        </p>
                  ...
                  <div className="md:col-span-7 md:row-span-2 grid grid-rows-2 gap-6">
                    {chunk[2] && (
                      <motion.div
                        ...
                        onClick={() =>
                          navigate(
                            `/portfolyo/${encodeURIComponent(chunk[2].title)}`,
                          )
                        }
                      ...
                      >
                        ...
                        <div className="absolute inset-y-0 left-8 flex flex-col justify-center">
                          ...
                          <h2 className="text-2xl font-light max-w-xs">
                            {chunk[2].title}
                          </h2>
                        </div>
                    ...
                    {chunk[3] && (
                      <motion.div
                        ...
                        onClick={() =>
                          navigate(
                            `/portfolyo/${encodeURIComponent(chunk[3].title)}`,
                          )
                        }
                      ...
                      >
                        ...
                        <div className="absolute bottom-6 left-8 right-8 flex justify-between items-end">
                          <div>
                            <p className="text-cef-orange text-xs tracking-widest uppercase mb-1">
                              {chunk[3].category}
                            </p>
