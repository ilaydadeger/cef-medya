...
export default function Iletisim() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!privacy) {
      setStatus('error');
      setErrorMessage('Devam etmek için gizlilik sözleşmesini onaylamanız gerekmektedir.');
      return;
    }
    ...
    try {
      ...
      if (result.success) {
        ...
        setStatus('error');
        setErrorMessage(result.message || 'Bir hata oluştu, lütfen daha sonra tekrar deneyiniz.');
      }
    } catch (err) {
      setStatus('error');
      setErrorMessage('Sunucuya ulaşılamıyor, lütfen daha sonra tekrar deneyiniz.');
    }
  };
  return (
    <div className="bg-cef-black min-h-screen text-cef-cream selection:bg-cef-orange selection:text-white">
      ...
      <section className="px-8 md:px-16 lg:px-32 pb-32">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24">
          ...
          >
            <div>
              <h2 className="text-3xl font-light mb-8 pb-4 border-b border-white/10">İletişim Adreslerimiz</h2>
              ...
              <div className="flex flex-col gap-8">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-sm uppercase tracking-widest text-white/50 mb-2">Adres</h3>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-sm uppercase tracking-widest text-white/50 mb-2">E-Posta</h3>
                    <a href={`mailto:${data.general.contact.email}`} className="font-light text-lg hover:text-cef-orange transition-colors">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-sm uppercase tracking-widest text-white/50 mb-2">Telefon</h3>
                    <a href={`tel:${data.general.contact.phone.replace(/[^0-9]/g, '')}`} className="font-light text-lg hover:text-white transition-colors">
            ...
            <div>
              <h3 className="text-sm uppercase tracking-widest text-white/50 mb-6">Bizi Takip Edin</h3>
              <div className="flex gap-4">
                <a href={data.general.socialLinks.instagram} target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center hover:bg-white/10 hover:text-cef-orange transition-all duration-300">
                  <InstagramIcon size={20} strokeWidth={1.5} />
                </a>
                <a href={data.general.socialLinks.linkedin} target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center hover:bg-white/10 hover:text-cef-turquoise transition-all duration-300">
            ...
            <div className="bg-white/[0.02] border border-white/5 backdrop-blur-md p-8 md:p-12 shadow-2xl relative overflow-hidden">
              ...
              <div className="relative z-10">
                <p className="text-xl font-light text-white/80 mb-10 leading-relaxed italic border-l-2 border-cef-orange pl-6">
                  "İletişim, başarıya giden yolda ilk adımdır. <br className="hidden md:block" />Haydi, birlikte harika şeyler yapalım!"
                </p>
                  ...
                  <div className="flex items-start gap-4 mt-2">
                    <div className="relative flex items-center justify-center mt-1">
                      <input 
                        ...
                        id="privacy" 
                        checked={privacy}
                        onChange={(e) => { setPrivacy(e.target.checked); setStatus('idle'); }}
                    ...
                    <label htmlFor="privacy" className="text-sm font-light text-white/50 cursor-pointer select-none leading-relaxed">
